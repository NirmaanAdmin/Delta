                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <dl class="tw-grid tw-grid-cols-1 tw-gap-x-4 tw-gap-y-5 sm:tw-grid-cols-2">
                            ...
                            <div class="sm:tw-col-span-1 project-overview-address">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('Address'); ?>
                                </dt>
                            ...
                            <div class="sm:tw-col-span-1 project-overview-zip-code">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('Zip Code'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-text-sm tw-text-neutral-900"><?php echo e($project->zip_code); ?> </dd>
                            </div>

                            <div class="sm:tw-col-span-1 project-overview-gst-number">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('GST Number'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-text-sm tw-text-neutral-900"><?php echo e($project->gst_number); ?> </dd>
                            </div>

                            <div class="sm:tw-col-span-1 project-overview-pan-number">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('PAN'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-text-sm tw-text-neutral-900"><?php echo e($project->pan_number); ?> </dd>
                            </div>

                            <div class="sm:tw-col-span-1 project-overview-company-logo">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('LOGO'); ?>
                                </dt>
