                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-6" style="padding: 0px;">
                                    <div class="form-group">
                                        <?php 
                                        $set_total_work= (isset($task) ? $task->set_total_work : ''); 
                                        echo  render_input('set_total_work', 'Measurement', $set_total_work, 'number') ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        foreach ($units as $group) {
                                            if (isset($task)) {
                                                if ($task->unit == $group['unit_id']) {
                                                    $selected = $group['unit_id'];
                                                }
                                            }
                                        }
                                       
                                        echo render_select('unit', $units, array('unit_id', 'unit_name'), 'Unit', $selected);
                                        ?>
                                    </div>
                                </div>
                            </div>
