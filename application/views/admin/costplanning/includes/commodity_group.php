  ...
  <tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="<?php echo admin_url('costplanning/delete_commodity_group_type/'.$commodity_group_type['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
        </td>
    </tr>
    <?php } ?>
 </tbody>
...
<div class="modal fade" id="commodity_group_type" tabindex="-1" role="dialog">
        <div class="modal-dialog setting-handsome-table">
          <?php echo form_open_multipart(admin_url('costplanning/commodity_group_type'), array('id'=>'add_commodity_group_type')); ?>
