...
<div id="list_wo_report" class="hide">
   <div class="col-md-3 form-group" style="padding-left: 0px;">
      <select name="wo_vendor[]" id="wo_vendor" class="selectpicker" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('vendor'); ?>">
         <option value=""></option>
         <?php
