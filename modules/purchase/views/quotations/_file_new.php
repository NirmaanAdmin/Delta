         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12 border-right project_file_area">
                  ...
                  <?php } ?>
                  <?php
                     $path = get_upload_path_by_type('purchase').'pur_quotation/'.$file->rel_id.'/'.$file->file_name;
                     $file_url = base_url('uploads/purchase/pur_quotation/' . $file->rel_id . '/' . $file->file_name);
                     if(is_image($path)){ ?>
                  <img src="<?php echo $file_url; ?>" class="img img-responsive ">
                  ...
                  <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=<?php echo $file_url; ?>' width='100%' height='100%' frameborder='0'>
                  </iframe>
