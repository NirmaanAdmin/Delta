            ...
            <div class="row">
               <div class="col-md-12 border-right project_file_area">
                  ...
                  <?php
                     ...
                     $path = base_url('uploads/purchase/' . $rel_type . '/' . $file->rel_id . '/' . $file->file_name);
                     if(is_image($path)){ ?>
                  ...
                  <iframe src="<?php echo $path; ?>" height="100%" width="100%" frameborder="0"></iframe>
                  <?php } else if(strpos($file->file_name,'.xls') !== false && empty($file->external)){ ?>
                  <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=<?php echo $path; ?>' width='100%' height='100%' frameborder='0'>
                  </iframe>
