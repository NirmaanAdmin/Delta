                ...
                <div class="form-group">
                  ...
                  <select name="vendorid" id="vendorid" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                    ...
                    <?php foreach ($vendors as $s) { ?>
                      <option value="<?php echo pur_html_entity_decode($s['userid']); ?>" <?php if (isset($debit_note) && $debit_note->vendorid == $s['userid']) {
                                                                                            echo 'selected';
                                                                                          } else {
                      ...
                      <div class="form-group select-placeholder">
                        ...
                        <select name="discount_type" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                          ...
                          <option value="before_tax" <?php
                                                      if (isset($debit_note)) {
                                                        if ($debit_note->discount_type == 'before_tax') {
                                                          echo 'selected';
                                                        }
                                                      } ?>><?php echo _l('discount_type_before_tax'); ?></option>
                          <option value="after_tax" <?php if (isset($debit_note)) {
                                                      if ($debit_note->discount_type == 'after_tax') {
                                                        echo 'selected';
                                                      }
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-5">
                          <div class="input-group" id="discount-total">
                            ...
                            <input type="number" value="<?php echo (isset($debit_note) ? $debit_note->discount_percent : 0); ?>" class="form-control pull-left input-discount-percent<?php if (isset($debit_note) && !is_sale_discount($debit_note, 'percent') && is_sale_discount_applied($debit_note)) {
                                                                                                                                                                                        echo ' hide';
                                                                                                                                                                                      } ?>" min="0" max="100" name="discount_percent">

                            <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php echo (isset($debit_note) ? $debit_note->discount_total : 0); ?>" class="form-control pull-left input-discount-fixed<?php if (!isset($debit_note) || (isset($debit_note) && !is_sale_discount($debit_note, 'fixed'))) {
                                                                                                                                                                                                                                                                                echo ' hide';
                            ...
                            <div class="input-group-addon">
                              <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" id="discount-total-type-dropdown" aria-labelledby="dropdown_menu_tax_total_type">
                                  <li>
                                    <a href="#" class="discount-total-type discount-type-percent<?php if (!isset($debit_note) || (isset($debit_note) && is_sale_discount($debit_note, 'percent')) || (isset($debit_note) && !is_sale_discount_applied($debit_note))) {
                                                                                                  echo ' selected';
                                                                                                } ?>">%</a>
                                  </li>
                                  <li>
                                    <a href="#" class="discount-total-type discount-type-fixed<?php if (isset($debit_note) && is_sale_discount($debit_note, 'fixed')) {
                                                                                                echo ' selected';
                                                                                              } ?>">
                  ...
                  <tr>
                    <td>
                      <div class="row">
                        ...
                        <div class="col-md-5">
                          <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php if (isset($debit_note)) {
                                                                                                                                                    echo $debit_note->adjustment;
                                                                                                                                                  } else {
                                                                                                                                                    echo 0;
