...
class fixed_equipment_model extends app_model
{
	 ...
	 * @return array or object    
	 */
	public function get_status_label_deilvery()
	{
			return $this->db->get(db_prefix() . 'fe_deilvery_status_labels')->result_array();
	}
	/**
	 * add asset
	 * @param array $data 
	...
	public function add_log($admin_id = '', $action = '', $item_id = '', $target = '', $changed = '', $to = '', $to_id = '', $notes = '', $consumable_quantity = '')
	{
		...
		$data['to_id'] = $to_id;
		$data['notes'] = $notes;
		$data['consumable_quantity'] = $consumable_quantity;
	 ...
	 * @return [type]                    
	 */
	public function create_goods_receipt_row_template(
		$warehouse_data = [],
		$name = '',
		$commodity_name = '',
		$warehouse_id = '',
	 ...
	 * @return [type]                        
	 */
	public function create_goods_delivery_row_template(
		$warehouse_data = [],
		$name = '',
		$commodity_name = '',
		$warehouse_id = '',
