...
if (default_project != null && default_project != '') {
  var $projectSelects = $('select[name="project"], select[name="project_id"], select[name="projects"], select[name="project_filter"], select[name="projects[]"], select[name="project[]"]');
