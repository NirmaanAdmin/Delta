...
function confirm_delete() {
	...
	return "undefined" != typeof app && (t = app.lang.confirm_action_prompt), 0 != confirm(t);
}
!(function (t) {
	var e = !1;
	t.fn.appFormValidator = function (n) {
		var i = this,
		o = { email: { remote: t.fn.appFormValidator.internal_options.localization.email_exists } },
		a = {
			rules: [],
			messages: [],
			ignore: [],
		...
		return (
			...
			(i.validateCustomFields = function (e) {
				t.each(e.find(t.fn.appFormValidator.internal_options.required_custom_fields_selector), function () {
					if (!t(this).parents("tr.main").length && !t(this).hasClass("do-not-validate") && (t(this).rules("add", { required: !0 }), t.fn.appFormValidator.internal_options.on_required_add_symbol)) {
						var e = t(this)
						.parents("." + t.fn.appFormValidator.internal_options.field_wrapper_class)
			...
			i.each(function () {
				var e = t(this);
				e.data("validator") && e.data("validator").destroy(), e.validate(r), i.validateCustomFields(e), i.addRequiredFieldSymbol(e), t(document).trigger("app.form-validate", e);
			})
			);
	};
})(jQuery),
($.fn.appFormValidator.internal_options = {
	...
	error_placement: function (t, e) {
		...
		: e.is("select") && (e.hasClass("selectpicker") || e.hasClass("ajax-search"))
		? t.insertAfter(e.parents("." + $.fn.appFormValidator.internal_options.field_wrapper_class + " *").last())
		: t.insertAfter(e);
	},
	...
	error_unhighlight: function (t) {
		...
		e.length &&
		0 === e.find("." + $.fn.appFormValidator.internal_options.field_wrapper_error_class).length &&
		$('a[href="#' + e.attr("id") + '"]')
		.removeAttr("style")
	...
	highlight: function (t, e, n, i) {
		if (3 === t.nodeType) {
			...
			if (o) {
				...
				var s = r.cloneNode(!0);
				return r.parentNode.tagName && "textarea" !== r.parentNode.tagName.toLowerCase() && (a.appendChild(s), r.parentNode.replaceChild(a, r)), 1;
			}
		} else if (1 === t.nodeType && t.childNodes && !/(script|style)/i.test(t.tagName) && (t.tagName !== n.toUpperCase() || t.className !== i))
		for (var l = 0; l < t.childNodes.length; l++) l += jQuery.highlight(t.childNodes[l], e, n, i);
			return 0;
	},
}),
(jQuery.fn.highlight = function (t, e) {
	var n = { className: "highlight animated flash", element: "span", caseSensitive: !1, wordsOnly: !1 };
	if (
		(jQuery.extend(n, e),
...
(function (t) {
	t.fn.googleDrivePicker = function (e) {
		...
		function o(e) {
			...
			gapi.load("picker", function () {
				...
				e.addEventListener("click", function () {
					var e;
					i || (i = google.accounts.oauth2.initTokenClient({ client_id: r.clientId, scope: r.scope, callback: "" })),
					(e = function () {
						var e = new google.picker.DocsView().setIncludeFolders(!0),
						i = new google.picker.DocsUploadView().setIncludeFolders(!0);
						r.mimeTypes && (e.setMimeTypes(r.mimeTypes), i.setMimeTypes(r.mimeTypes)),
		...
		function a(t) {
			if (t[google.picker.Response.ACTION] == google.picker.Action.PICKED) {
				...
				t[google.picker.Response.DOCUMENTS].forEach(function (t) {
					e.push({ name: t[google.picker.Document.NAME], link: t[google.picker.Document.URL], mime: t[google.picker.Document.MIME_TYPE] });
				}),
		...
		return this.each(function () {
			r.clientId ? (t(this).data("on-pick") && (r.onPick = t(this).data("on-pick")), o(t(this)[0]), t(this).css("opacity", 1)) : t(this).css("opacity", 0);
		});
	};
})(jQuery),
($.fn.googleDrivePicker.defaults = { scope: "https://www.googleapis.com/auth/drive", mimeTypes: null, developerKey: "", clientId: "", onPick: function (t) {} }),
(function () {
	"use strict";
	function t(i) {
...
(function () {
		...
		for (var n in e) {
			...
			for (var a in this.waypoints[n]) {
				...
				if (null !== r.triggerPoint) {
					...
					((s && l) || (!s && !l)) && (r.queueTrigger(o), (t[r.group.id] = r.group));
				}
			}
		}
	...
	(e.prototype.refresh = function () {
		...
		for (var s in this.waypoints[a]) {
			...
			"function" == typeof f ? (f = f.apply(u)) : "string" == typeof f && ((f = parseFloat(f)), u.options.offset.indexOf("%") > -1 && (f = Math.ceil((r.contextDimension * f) / 100))),
			(l = r.contextScroll - r.contextOffset),
			(u.triggerPoint = Math.floor(m + l - f)),
			(d = h < r.oldScroll),
			(p = u.triggerPoint >= r.oldScroll),
			(c = !d && !p),
			!g && d && p ? (u.queueTrigger(r.backward), (i[u.group.id] = u.group)) : ((!g && c) || (g && r.oldScroll >= u.triggerPoint)) && (u.queueTrigger(r.forward), (i[u.group.id] = u.group));
		}
	}
	return (
...
(function (t) {
	...
	(t.fn.isOnScreen = function (e, n) {
		(null != e && void 0 !== e) || (e = 1), (null != n && void 0 !== n) || (n = 1);
		var i = t(window),
		...
		return this.each(function () {
			...
			i = {
				...
				adjustScroll: function () {
					...
					n.find(".nav-tabs-horizontal li:not(.nav-tabs-submenu-child, nav-tabs-submenu-parent)").each(function (i, a) {
						(r += t(a).outerWidth()), t(a).hasClass("active") && r > n.width() && (o = t(a)), t(a).is(":last-child") && (e = t(a));
					}),
					(widthAvailale = n.width()),
					r > widthAvailale ? (n.find(".scroller").show(), i.updateArrowStyle(s), (a = n.find(".nav-tabs-horizontal").outerWidth())) : n.find(".scroller").hide(),
					o &&
					setTimeout(function () {
						(s = o.position().left - i.getArrowsTotalWidth()), n.find(".nav-tabs-horizontal").animate({ scrollLeft: s }, 100);
					}, 150);
				},
				scrollLeft: function () {
					n.find(".nav-tabs-horizontal").animate({ scrollLeft: s - a }, 500), s - a > 0 ? (s -= a) : (s = 0);
				},
				scrollRight: function () {
					n.find(".nav-tabs-horizontal").animate({ scrollLeft: s + a }, 500), s + a < r - a ? (s += a) : (s = r - a);
				},
				manualScroll: function () {
					(s = n.find(".nav-tabs-horizontal").scrollLeft()), i.updateArrowStyle(s);
				},
				...
				clearMenuItem: function (e) {
					t('[data-sub-menu-id="' + e.attr("data-menu-id") + '"]').remove(), e.removeAttr("data-menu-id");
				},
			...
			return (
				...
				o.on("click", function (e) {
					...
					a
					.find("ul")
					.css({ top: r.top + n.outerHeight() - 5, left: r.left, display: "block", "border-top-left-radius": "0", "border-top-right-radius": "0" })
					.attr("data-sub-menu-id", o),
					a.find("ul li.active:eq(0) > a").css({ "border-top-left-radius": "0", "border-top-right-radius": "0" }),
...
$(function () {
	...
	$("a[href='#top']").on("click", function (t) {
		t.preventDefault(), $("html,body").animate({ scrollTop: 0 }, 1e3), t.preventDefault();
	}),
	$("a[href='#bot']").on("click", function (t) {
		t.preventDefault(), $("html,body").animate({ scrollTop: $(document).height() }, 1e3), t.preventDefault();
	}),
	...
	$("body").on("change", 'select[name="range"]', function () {
		var t = $(".period");
		"period" == $(this).val() ? t.removeClass("hide") : (t.addClass("hide"), t.find("input").val(""));
	}),
	$(document).on("shown.bs.dropdown", ".table-responsive", function (t) {
		var e = $(t.target);
		if (!e.hasClass("bootstrap-select")) {
			var n = e.find(".dropdown-menu");
			n.length ? e.data("dropdown-menu", n) : (n = e.data("dropdown-menu")), n.css("top", e.offset().top + e.outerHeight() + "px");
			var i;
			n.css("display", "block"), n.css("position", "absolute");
			var o = e.parent().outerWidth(),
			a = n.outerWidth();
			(i = e.parent().offset().left - (a - o)), n.css("left", i + "px"), n.css("right", "auto"), n.appendTo("body");
		}
	}),
...
function _create_print_window(t) {
	...
	return (e += ", height=" + screen.height), (e += ", top=0, left=0"), (e += ", fullscreen=yes"), window.open("", t, e);
}
...
function tilt_direction(t) {
	setTimeout(function () {
		...
		n = function (n) {
			n.pageX >= e ? (t.addClass("right"), t.removeClass("left")) : (t.addClass("left"), t.removeClass("right")), (e = n.pageX);
		};
...
function close_modal_manually(t) {
	(t = 0 === $(t).length ? $("body").find(t) : (t = $(t))).fadeOut("fast", function () {
		t.remove(), $("body").find(".modal").is(":visible") || ($(".modal-backdrop").remove(), $("body").removeClass("modal-open"));
	});
}
...
function appColorPicker(t) {
	void 0 === t && (t = $("body").find("div.colorpicker-input")), t.length && t.colorpicker({ format: "hex" });
}
function appSelectPicker(t) {
	void 0 === t && (t = $("body").find("select.selectpicker")), t.length && t.selectpicker({ showSubtext: !0 });
}
...
function appLightbox(t) {
	...
	var e = { showImageNumberLabel: !1, resizeDuration: 200, positionFromTop: 25 };
...
function _table_jump_to_page(t, e) {
	...
	if ((i.length && i.remove(), n.pages > 1)) {
		for (var o = $("<select></select>", { "data-id": e.sTableId, class: "dt-page-jump-select form-control", id: "dt-page-jump-" + e.sTableId }), a = "", r = 1; r <= n.pages; r++) {
			a += "<option value='" + r + "'" + (n.page + 1 === r ? "selected" : "") + ">" + r + "</option>";
		}
		"" != a && o.append(a), $("#" + e.sTableId + "_wrapper .dt-page-jump").append(o);
	}
}
function alert_float(t, e, n) {
	...
	(i = "alert_float_" + ++i),
	(o = $("<div></div>", { id: i, class: "float-alert animated fadeInRight col-xs-10 col-sm-3 alert alert-" + t })).append(
...
function generatePassword(t) {
	for (var e = "abcdefghijklnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", n = "", i = 0; i < 12; ++i) n += e.charAt(Math.floor(61 * Math.random()));
		$(t).parents().find("input.password").val(n);
}
function get_url_param(t) {
	var e = {};
	return (
		window.location.href.replace(location.hash, "").replace(/[?&]+([^=&]+)=?([^&]*)?/gi, function (t, n, i) {
			e[n] = void 0 !== i ? i : "";
		}),
		t ? (e[t] ? e[t] : null) : e
		);
	...
	if (0 !== n.length) {
		...
		r = {
			...
			initComplete: function (t, e) {
				...
				if ((i.length && i.attr("colspan", this.find("thead th").length), s.supportsLoading && this.parents(".table-loading").removeClass("table-loading"), s.supportsButtons)) {
					...
					a.find('input[type="checkbox"]').length > 0 && a.addClass("not-export"), "function" == typeof s.onInitComplete && s.onInitComplete(t, e, this);
				}
			},
		},
		s = $.extend({}, r, e),
		...
		-1 == $.inArray(s.pageLength, l) && (l.push(s.pageLength), d.push(s.pageLength)),
		l.sort(function (t, e) {
			return t - e;
		}),
		d.sort(function (t, e) {
		...
		$.each(n, function () {
			if (($(this).addClass("dt-inline"), (i = $(this).attr("data-order-col")), (o = $(this).attr("data-order-type")), (a = $(this).attr("data-s-type")), i && o && (s.order = [[i, o]]), a)) {
				a = JSON.parse(a);
			...
			s.supportsButtons && (s.buttons = get_datatable_buttons(this)), $(this).DataTable(s);
		});
	}
}
function get_datatable_buttons(t) {
	if (("persian" == app.user_language.toLowerCase() || "arabic" == app.user_language.toLowerCase()) && 0 === $("body").find("#amiri").length) {
		...
		n.setAttribute("src", "https://rawgit.com/xErik/pdfmake-fonts-google/master/build/script/ofl/amiri.map.js"), document.head.appendChild(n);
	}
	...
	var o = {
		body: function (t, e, n, i) {
			...
			var vinInput = o.querySelector("input");
			if (vinInput) {
	            return vinInput.value ? vinInput.value.trim() : ""; // Ensure it is a string
	        }

	        let noteEditArea = o.querySelector("[data-note-edit-textarea]");
	        if (noteEditArea) {
	        	noteEditArea.remove();
	        }

	        let dateText = o.querySelector(".text-has-action.is-date");
	        if (dateText) {
	            return dateText.getAttribute("data-title") || ""; // Ensure a string is returned
	        }

	        let rowOptions = o.querySelector(".row-options");
	        if (rowOptions) {
	        	rowOptions.remove();
	        }

	        let tableExclude = o.querySelector(".table-export-exclude");
	        if (tableExclude) {
	        	tableExclude.remove();
	        }

	        let textContent = o.textContent ? o.textContent.trim() : "";
	        return textContent = textContent.replace(/₹|,/g, "");
    }
},
a = [];
...
function slideToggle(t, e) {
	var n = $(t);
	n.hasClass("hide") && n.removeClass("hide", "slow"), n.length && n.slideToggle();
...
function appDatepicker(t) {
	...
	var e = { date_format: app.options.date_format, time_format: app.options.time_format, week_start: app.options.calendar_first_day, date_picker_selector: ".datepicker", date_time_picker_selector: ".datetimepicker" },
	n = $.extend({}, e, t),
	...
	($.each(i, function () {
		var t = $(this),
		e = { timepicker: !1, scrollInput: !1, lazyInit: !0, format: n.date_format, dayOfWeekStart: n.week_start },
	...
	$.each(o, function () {
		var t = $(this),
		e = { lazyInit: !0, scrollInput: !1, validateOnBlur: !1, dayOfWeekStart: n.week_start };
		24 == n.time_format ? (e.format = n.date_format + " H:i") : ((e.format = n.date_format + " g:i A"), (e.formatTime = "g:i A"));
...
function _dropzone_defaults() {
	...
	return (
		"safari" === app.browser && t.indexOf(".jpg") > -1 && -1 === t.indexOf(".jpeg") && (t += ",.jpeg"),
		{
...
function escapeHtml(t, e = !0) {
	...
	return e || (n = n.replace(/&amp;(#\d+;|#[xX][\da-fA-F]+;|[a-zA-Z]+;)/g, "&$1")), n;
}
function init_tinymce_inline_editor(t = {}, e) {
	function n(e) {
		t.saveUsing && t.saveUsing(e);
	}
	(e = e || "div.editable"), tinymce.remove(e);
	var i = {
		selector: e,
		inline: !0,
		toolbar: !1,
